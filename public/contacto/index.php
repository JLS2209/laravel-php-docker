...
if (isset($_SESSION["id_rol"])) {
    error_log("Intento de acceso sin ser visitante!");
    header("location: ../");
}
...
<body>
                            ...
                            <form class="row g-3" id="form-validacion" method="post" action="controller.php" novalidate>
                                ...
                                <div class="form-floating col-md-6 mb-3">
                                    <input type="text" class="form-control" id="txtNombre" name="nombre" placeholder=""
                                        pattern="([A-Za-z]|[ÁÉÍÓÚáéíóúÑñüÜ ]){3,30}" required>
                                ...
                                <div class="form-floating col-md-6 mb-3">
                                    <input type="text" class="form-control" id="txtApellido" name="apellido"
                                        placeholder="" pattern="([A-Za-z]|[ÁÉÍÓÚáéíóúÑñüÜ ]){3,30}" required>
                                ...
                                <div class="form-floating col-md-6 mb-3">
                                    <input type="tel" class="form-control" id="txtTelefono" name="telefono"
                                        placeholder="" pattern="[0-9]{9,10}" required>
    ...
    if (isset($_SESSION["mensaje"])) {
        switch ($_SESSION["mensaje"]) {
            case 1: msg("Operación exitosa", "Mensaje enviado", "success"); break;
            case -1: msg("Operación fallida", "No se pudo enviar el mensaje", "error"); break;
            case -10: msg("Operación fallida", "Hubo un error", "error"); break;
        }
    }
