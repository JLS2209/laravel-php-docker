    ...
    <div class="container-fluid"
        ...
        <div class="container py-4" style="background-color: rgba(0, 0, 0, 0.8); color: wheat;">
            ...
            <div class="d-grid gap-2 col-6 mx-auto">
                <button class="btn btn-dark btn-lg" type="button">Generar Reporte de Empleados</button>
            </div>
                            ...
                            <form class="row g-3" method="post" action="controller.php" id="frm-insert-update"
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="txtApellido" name="apellido"
                                        placeholder="" pattern="([A-Za-z]|[ÁÉÍÓÚáéíóúÑñüÜ ]){3,30}" required autofocus>
                                ...
                                <!-- Input Rol -->
                                <div class="form-floating mb-3">
                                    <select class="form-select" id="cbxRol" name="id-rol" required>
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="txtUsuario" name="usuario"
                                        placeholder="" pattern="[a-z0-9._%+\-]{10,80}" required autofocus>
                                ...
                                <div class="form-floating col-10 mb-3">
                                    ...
                                    <div class="invalid-feedback">
                                        ...
                                        menos
                                        un dígito, una letra mayúscula y una letra minúscula.
                                    </div>
                                </div>
                                <div class="col-2">
